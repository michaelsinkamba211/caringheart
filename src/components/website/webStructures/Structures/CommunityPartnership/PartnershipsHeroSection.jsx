        ...
        <div className="relative max-w-325 mx-auto px-2 text-center">
            ...
            >
                ...
                <h1 className="text-3xl sm:text-4xl font-light text-white leading-tight mb-4 max-w-xl mx-auto">
                    ...
                    <span className="text-magenta font-normal">community, together</span>
                </h1>

                <p className="text-sm text-white/60 leading-relaxed max-w-lg mx-auto">
                    We believe exceptional care extends beyond the homes of our clients — we're
                    committed to meaningful partnerships across Massachusetts.
                </p>
            </motion.div>
        </div>
    </section>
