        ...
        <div className="relative max-w-325 mx-auto px-2 text-center">
            ...
            >
                <div className="flex items-center justify-center gap-1.5 text-xs text-white/50 mb-6">
                    ...
                    <span className="text-white/80">Our Care Process</span>
                </div>
                ...
                <h1 className="text-3xl sm:text-4xl font-light text-white leading-tight mb-4 max-w-xl mx-auto">
                    Simple, supportive,<br />
                    <span className="text-magenta font-normal">personalized</span>
                </h1>

                <p className="text-sm text-white/60 leading-relaxed max-w-lg mx-auto">
                    Choosing home care is an important decision. We partner with you every step
                    of the way to ensure your loved one receives the right care at the right time.
                </p>
            </motion.div>
        </div>
    </section>
